(function() {
	if (Nash.isLargeScreen()) {
		Nash.ui = {
			mainBackgroundImage: 'images/backgrounds/background_main.png',
			dashboardHeight: 640,
			dashboardWidth: 590,
			//FOWP:'http://www.friendsofNashparks.com/'
		};
	} else {
		Nash.ui = {
			mainBackgroundImage: 'images/backgrounds/background_main.png',
	...
	if (Nash.isAndroid()) {
		Nash.ui.backgroundSelectedProperty = 'backgroundSelected';
	} else {
		Nash.ui.backgroundSelectedProperty = 'selectedBackground';
	}
	...
	/*Nash.ui.createHeaderRow = function(title) {
	...
	Nash.ui.createTabbedScrollableView = function(params) {
