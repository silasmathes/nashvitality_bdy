(function() {	
	 ...
	 */
	Nash.datetime.strtotime = function (str, now) {
	...
	Nash.datetime.prettyDate = function (time) {
	...
	Nash.datetime.getTwitterInterval = function (strDateTime) {
	    return Nash.datetime.prettyDate(Nash.datetime.strtotime(strDateTime));
	};
	
	Nash.datetime.dayToName = function (day) {
	    switch (day) {
	    case 0:
	        return 'Sunday';
	    case 1:
	...
	Nash.datetime.monthToName = function (month) {
	    switch (month) {
	    case 1:
	        return 'January';
	    case 2:
	...
	Nash.datetime.cleanDate = function (date) {
	    var label;
	    switch (date.getDate()) {
	    case 1:
	        label = 'st';
	    ...
	    return Nash.datetime.dayToName(date.getDay()) + ', ' + Nash.datetime.monthToName(date.getMonth() + 1) + ' ' + date.getDate() + label;
	};
	
	Nash.datetime.cleanTime = function (time) {
